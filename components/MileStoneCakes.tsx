        ...
        <div className="wrapper">
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-0">
            <div
              ...
              className="flex w-full flex-col items-center md:px-4 lg:px-7"
            >
            ...
            <div
              data-aos="zoom-in-right"
              data-aos-delay="300"
              className="flex w-full flex-col items-center md:border-x-2 md:border-black md:px-4 lg:px-7"
            >
              <figure className="h-[200px] w-full overflow-hidden md:h-[250px]">
                <Image
                  src={NumberCake}
          ...
          <p
            data-aos="fade"
            className="mt-16 leading-[150%] md:px-4 md:text-xl md:leading-[150%] lg:px-7 lg:leading-[155%]"
          >
