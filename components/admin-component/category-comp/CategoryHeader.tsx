        ...
        <>
          ...
          {categories && categories.length >= 1 && (
            <Link
              ...
              className="inline-block rounded-md bg-neutral-900 px-3 py-2 text-sm text-brand-200"
            >
              New Category
            </Link>
          )}
      ...
      {!pathname.endsWith("/manage-categories") && (
        <>
          ...
          <button
            ...
            className="rounded-md bg-neutral-900 px-4 py-2 text-sm text-brand-200 disabled:opacity-75 disabled:hover:cursor-not-allowed"
