...
const OverviewCard = ({ data }: any) => {
  return (
    <Card className="w-full border-0 bg-brand-200 md:w-[400px] xl:w-full">
      <CardHeader className="pb-0">
        <CardTitle>
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-brand-100 text-brand-200">
            <data.icon />
          </span>
          <p className="mt-3 text-lg text-brand-100">{data?.title}</p>
        </CardTitle>
      </CardHeader>
